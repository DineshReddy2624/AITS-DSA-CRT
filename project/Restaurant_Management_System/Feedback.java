...
public class Feedback {
    ...
    // Setter for feedbackId (if it's auto-generated and needs to be set after insertion)
    ...
    public String toString() {
        return "Feedback ID: " + feedbackId +
               ...
               ", Comments: " + (comments != null ? comments.substring(0, Math.min(comments.length(), 50)) + (comments.length() > 50 ? "..." : "") : "N/A");
    }
}
